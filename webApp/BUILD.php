...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="'.$toRootRelStr.'assets/css/index.css" />
    ...
    <script type="text/javascript" src="'.$toRootRelStr.'assets/js/index.js"></script>
</head>
<body>
    <noscript>
        <style>
                            ...
                            if (isset($sessionData['player'])) {
                                ...
                                echo '
                                   ...
                                   <li class="nav-item'; if ($subFolderPath == '' && $viewName == 'set') { echo ' active'; }; echo'">
                                        <a class="nav-link" href="'.$toRootRelStr.'set"><i class="fa fa-cog"></i> Nastavení</a>
                                    </li>
                                ';
                            }
                            echo '
